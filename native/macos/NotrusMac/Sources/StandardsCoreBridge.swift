...
enum StandardsCoreBridge {
    ...
    private static let encoder: JSONEncoder = {
        ...
        encoder.keyEncodingStrategy = .custom { keys in
            DynamicCodingKey(stringValue: underscoreSeparated(keys.last?.stringValue ?? ""))!
        }
        return encoder
    }()
    ...
    private static let decoder: JSONDecoder = {
        ...
        decoder.keyDecodingStrategy = .custom { keys in
            DynamicCodingKey(stringValue: lowerCamel(keys.last?.stringValue ?? ""))!
        }
        return decoder
    }()

    private static func underscoreSeparated(_ value: String) -> String {
        var output = ""
