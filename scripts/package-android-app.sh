...
APP_VERSION="${NOTRUS_ANDROID_VERSION:-0.2.0-alpha2}"
...
rm -f \
  ...
  "$DIST_DIR/NotrusAndroid-$APP_VERSION-debug.apk" \
  "$DIST_DIR/NotrusAndroid-$APP_VERSION-debug.apk.sha256" \
  "$DIST_DIR/NotrusAndroid-$APP_VERSION-release.apk" \
  "$DIST_DIR/NotrusAndroid-$APP_VERSION-release.apk.sha256" \
...
cp "$DEBUG_APK" "$DIST_DIR/NotrusAndroid-$APP_VERSION-debug.apk"
cp "$RELEASE_APK" "$DIST_DIR/NotrusAndroid-$APP_VERSION-$RELEASE_LABEL.apk"
...
shasum -a 256 "$DIST_DIR/NotrusAndroid-$APP_VERSION-debug.apk" > "$DIST_DIR/NotrusAndroid-$APP_VERSION-debug.apk.sha256"
shasum -a 256 "$DIST_DIR/NotrusAndroid-$APP_VERSION-$RELEASE_LABEL.apk" > "$DIST_DIR/NotrusAndroid-$APP_VERSION-$RELEASE_LABEL.apk.sha256"
